(function defineLearningContent(root) {
  ...
  const supportByFloor = {
    ...
    17:{mode:'change',instruction:'用意された入力コードへprint(mob)を追加し、受け取った値を確認しよう。',hints:['mob = input()の次にprint(mob)を書きます。','この相手は仲間なのでsayHello()です。']},
    ...
    19:{mode:'change',instruction:'用意された判断コードの条件と対応処理を変更し、3体へ対応しよう。',hints:['条件はmob == "enemy"です。','elseの中はsayHello()です。']},
